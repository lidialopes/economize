...
public class TelaAjuda extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jTextPane1.setFont(new java.awt.Font("Segoe UI Light", 0, 15)); // NOI18N
        jTextPane1.setText("Olá, bem vindo ao Economize!\n\nObrigado por fazer parte desse projeto.\n\nPasso a passo:\n\n1. Ao fazer o login pela primeira vez seu saldo será zero e você deve fazer um cadastro de \"Ganho\" ou \"Gasto\" na opção \"Cadastro de Lançamento\" no menu lateral esquerdo.\n\n2. Para ver seus lançamentos vá ao menu e clique na opção \"Relatório\". Para mostrar todas seus lançamentos, escolha o seu filtro e clique em \"Mostrar\".\n\n3. Para cadastrar uma meta, vá ao menu e clique na opção \"Cadastrar Meta\". Você poderá cadastrar uma meta.\n\n4. Para mostrar suas metas cadastradas vá ao menu e busque por \"Mostrar metas cadastradas\". \n\n5. Você terá todos os dados relacionados ao mês vigente na sua \"Home\", será possível olhar quanto você ganhou e gastou por exemplo.\n");
